package com.sistecredito.hellokotlin
...
class MainActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun speak(){
        ...
        if (message.isEmpty()){
            findViewById<TextView>(R.id.tvStatus).text = "Debes introducir un texto!"
            message = "¿Es enserio? Debes escribir algo en el edit Text"
        }
